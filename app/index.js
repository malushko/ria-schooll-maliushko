...
/**
 * @example curl -v -X POST "http://127.0.0.1:2555/users" -d '{"name": "Vasya"}' -H "Content-Type: application/json"
 */
...
/**
 * @example curl -v -X PUT "http://127.0.0.1:2555/users/1" -d '{"name":"Petya"}' -H "Content-Type: application/json"
 */
